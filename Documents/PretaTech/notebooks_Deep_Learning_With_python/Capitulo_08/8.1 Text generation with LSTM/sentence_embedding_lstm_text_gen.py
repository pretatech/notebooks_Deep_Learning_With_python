'''
Geração de texto LSTM com base na "incorporação de frases"
'''
...
path = '/Users/c/Desktop/Jornadacultural.txt'
...
callbacks_list = [
    ...
    keras.callbacks.ReduceLROnPlateau(
        ...
        patience=2,            # Se o monitor não melhorar na rodada de paciência, ele aciona para reduzir a taxa de aprendizagem
    ),
    # Interrompa o treinamento quando não estiver mais melhorando
    keras.callbacks.EarlyStopping(
        monitor='loss',           # Indicador a ser verificado
        patience=4,             # Se o monitor não melhorar em mais do que rodadas de paciência (por exemplo, 10 + 1 = 11 rodadas aqui), pare o treinamento
    ),
]
...
for temperature in [0.2, 0.5, 1.0, 1.2]:
    ...
    for i in range(100):    # Gerar 400 tokens
